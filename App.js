  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        <Image style={{ width: 250, resizeMode: 'contain' }} source={require('./src/assets/imagem/logo.gif')} />
        <View>
      ...
      <View style={styles.botton}>
        ...
        <View>
          <Image style={{ width: 150, resizeMode: 'contain' }} source={require('./src/assets/imagem/Logo-name-sf.png')} />
        </View>
      </View>
